...
<head>
  ...
  <!-- Author Meta -->
	<meta name="author" content="CECYTEG Comonfort">
    <!-- Meta Description -->
    <meta name="description" content="CPANEL CECYTEG Comonfort">
  <!--Icon-->
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <li class="nav-item dropdown">
      ...
      <a class="dropdown-item" href="../lib/logout.php">Cerrar Sesión</a>
        </div>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Configuración de la app</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <footer class="main-footer text-center">
    ...
    <!-- Default to the left -->
    <p>Copyright &copy; <?php echo date('Y') ?>. Todos los derechos reservados | CECyTE Guanajuato Plantel Comonfort</p>
  </footer>
</div>
<!-- ./wrapper -->
